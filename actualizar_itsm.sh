...
info "PRÓXIMOS PASOS:"
info "1. Verificar la aplicación en el navegador"
info "2. Probar las nuevas funcionalidades:"
info "   - Ver Historial de equipos (botón azul)"
info "   - Reportes PDF con plantillas"
info "   - Campos dinámicos por tipo de equipo"
info "   - Fecha de revisión en bitácoras"
info "3. Si hay problemas, ejecutar: bash rollback_itsm.sh $BACKUP_NAME"
echo ""
